...
public:
	...
	static ptrdiff_t FindIndex(const aya::string_t &str);
	static size_t FindIndexLongestMatch(const aya::string_t &str,size_t max_len = 0);
...
private:
	...
	CValue	ToLowerOrUpper(CSF_FUNCPARAM &p,const aya::char_t *funcname,bool isUpper);
...
protected:
	...
	CValue GETTAMAHWND(CSF_FUNCPARAM &p);
